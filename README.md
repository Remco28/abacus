...
Settings is grouped into Board, Practice, and Help. Practice holds the two ways to work, and they share one set of choices: the operations to practise (addition, subtraction, multiplication) and a level on each ladder, where adding and taking away is graded by the bead movement a step needs and multiplying by the width of its operands.
